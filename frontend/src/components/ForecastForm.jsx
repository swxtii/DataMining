...
//           <h2 className="text-2xl font-semibold text-center mb-6">Time Series Forecast</h2>
//           <ForecastPlot 
...
//             <p><strong>Best Model:</strong> {result.model || 'N/A'}</p>
//             <p><strong>MAPE:</strong> {result.mape ? (result.mape * 100).toFixed(2) : 'N/A'}%</p>
//           </div>
//         </div>
//       )}
//     </div>
...
//   return (
//     <div className="min-h-screen bg-gradient-to-tr from-gray-100 to-blue-50 flex flex-col items-center px-4 py-10">
...
//               <input
//                 type="date"
//                 className="w-full border border-gray-300 rounded-xl p-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
//                 value={fromDate}
//                 onChange={(e) => setFromDate(e.target.value)}
//               />
//             </div>
...
//               type="number"
//               min="1"
//               className="w-24 border border-gray-300 rounded-xl px-4 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
//               value={period}
//               onChange={(e) => setPeriod(Number(e.target.value))}
//             />
//           </div>
...
//           {error && (
//             <div className="bg-red-100 border border-red-200 text-red-800 px-4 py-3 rounded-xl text-center">
//               <strong>Error:</strong> {error}
//             </div>
//           )}
//         </div>
